...
- The mixed 10,000 gate executes 9,600 structured, 200 image, and 200 media Jobs across three durable lanes, injects/repairs 20 input-change blocks, records queue-latency P50/P95, RSS, WAL, and staging peaks, and independently probes all 400 engine outputs. `docs/testing/MIXED_TEN_THOUSAND.md` owns the Windows small-file queue evidence and its high-resolution/document boundary.
