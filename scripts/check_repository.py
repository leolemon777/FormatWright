...
def check_required_files(errors: list[str]) -> None:
    required = [
        ...
        "docs/security/RELEASE_KEYRING_CEREMONY.md",
        ...
        "docs/testing/DESKTOP_ACCESSIBILITY.md",
        "docs/testing/WINDOWS_EXPLORER_INTEGRATION.md",
        "docs/testing/DESKTOP_RELEASE_CONVERSION.md",
        "docs/testing/CLEAN_VM_CERTIFICATION.md",
        "docs/testing/LARGE_FILE_PHYSICAL.md",
        "docs/testing/RESOURCE_FAILURE_INJECTION.md",
        "docs/testing/TEN_THOUSAND_CONVERSIONS.md",
        "docs/testing/MIXED_SCHEDULER.md",
        "docs/testing/JOB_EXECUTION_SERVICE.md",
        "docs/testing/MULTI_PROCESS_QUEUE.md",
        "docs/testing/MIXED_TEN_THOUSAND.md",
        ...
        "docs/release/PRODUCT_DECISIONS.md",
        ...
        "scripts/cdp_accessibility_audit.mjs",
        "scripts/test_windows_explorer_integration.ps1",
        "scripts/test_desktop_release_conversion.ps1",
        "scripts/test_large_file_physical.ps1",
        "scripts/test_resource_failure_injection.ps1",
        "scripts/test_clean_vm_certification.ps1",
        "scripts/release_keyring_tool.py",
        "scripts/generate_engine_component_inventory.py",
        "scripts/cdp_desktop_conversion_e2e.mjs",
        "apps/desktop/src-tauri/tauri.release-e2e.conf.json",
        "scripts/test_mixed_scheduler.ps1",
        "scripts/test_mixed_ten_thousand.ps1",
        "scripts/test_multi_process_queue.ps1",
        "scripts/test_queue_crash_recovery.ps1",
